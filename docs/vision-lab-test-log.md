...
| 29–40.5 秒 | `posture_down` | 低頭睜眼看書，眼睛受到眼鏡遮擋 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 單幀 | 46.5% | 18 | 15 | 0 | 40 | 2 / 2 | -165.5 ms |
| 3-of-5 | 46.6% | 13 | 11 | 0 | 30 | 2 / 2 | -98.5 ms |

#### 逐狀態 Precision／Recall／F1

| 狀態 | Support | 單幀 P | 單幀 R | 單幀 F1 | 3-of-5 P | 3-of-5 R | 3-of-5 F1 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| normal | 903 | 61.9% | 48.0% | 0.540 | 61.7% | 48.1% | 0.540 |
| eye_closed | 150 | 23.8% | 100.0% | 0.384 | 23.9% | 100.0% | 0.386 |
| posture_down | 345 | 100.0% | 19.4% | 0.325 | 100.0% | 19.4% | 0.325 |

本片沒有 `head_turned` 或 `user_missing` Ground Truth，這兩種狀態的 P／R／F1 為 `N/A`。
...
| 29–40.5 秒低頭＋眼鏡遮擋 | 345 | 11（3.2%） | 9（2.6%） | 0.1634 | 33.3° |
...
- 本片的低頭眼鏡遮擋區段只有 3.2% 幀被零記憶閉眼旗標誤判，因此眼鏡遮擋在這支影片中
  不是主要閉眼誤報來源。
- 低頭區段只有 67 / 345 幀輸出 `posture_down`，Recall 為 19.4%；該段 abs(pitch) 中位數
  33.3°，接近但低於目前固定的 35° 門檻。這是另一個姿態校正問題，不與閉眼門檻混在同一次
  修改中。
