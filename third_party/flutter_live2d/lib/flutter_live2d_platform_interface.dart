...
abstract class FlutterLive2dPlatform extends PlatformInterface {
  ...
  /// Returns a value that changes whenever the installed app package changes.
  /// Used to invalidate extracted Flutter asset models after an app update.
  Future<String> getAssetCacheVersion() {
    throw UnimplementedError(
      'getAssetCacheVersion() has not been implemented.',
    );
  }
