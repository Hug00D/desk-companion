...
class _FaceDetectionScreenState extends State<FaceDetectionScreen> {
  ...
  void _handleVisionResult(VisionResult visionResult) {
    debugPrint(
      ...
      'hasHand=${visionResult.hasHand}, '
      'handGesture=${visionResult.handGesture}, '
    ...
    _updateGestureState(visionResult);
  ...
  void _updateGestureState(VisionResult visionResult) {
    _hasHand = visionResult.hasHand;
    _detectedGesture = visionResult.handGesture;

    if (visionResult.isVictoryGesture) {
  ...
  Future<void> _showGestureAlert() async {
    ...
    const message = "偵測到 YA 手勢，畫面提醒已觸發。";
